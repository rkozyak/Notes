...
\begin{figure}[H]%
	\hfill
	\subfigure[Zero Acceleration]{\begin{tikzpicture} \begin{axis}[xlabel = Time, ylabel = Velocity, width=4cm, height = 4cm] xmin = 0, xmax = 10, ymin = 0, ymax = 10, \addplot[domain = 0:10, smooth, thick] {5}; \end{axis} \end{tikzpicture}\label{fig:ZeroAcceleration}}
	\hfill
	\subfigure[Positive Acceleration]{\begin{tikzpicture} \begin{axis}[xlabel = Time, ylabel = Velocity, width=4cm, height = 4cm] xmin = 0, xmax = 10, ymin = 0, ymax = 10, \addplot[domain = 0:10, smooth, thick] {x}; \end{axis} \end{tikzpicture}\label{fig:PositiveAcceleration}}
	\hfill
	\subfigure[Negative Acceleration]{\begin{tikzpicture} \begin{axis}[xlabel = Time, ylabel = Velocity, width = 4cm, height = 4cm] xmin = 0, xmax = 10, ymin = 0, ymax = 10, \addplot[domain = 0:10, smooth, thick] {-x+10}; \end{axis} \end{tikzpicture}\label{fig:NegativeAcceleration}}
	\hfill
